...
class _ProductMangerScreenState extends State<ProductMangerScreen> {
    ...
    List<Product> products = List.filled(0, Product(TenSP: "", GiaSP: "", Tenshop: "", MoTa: "", SoLuong: "", Giamgia: "", Sdt: "", Trangthai: true, Image: ""),growable: true);
                        ...
                        SizedBox(
                          ...
                          child: Row(
                            ...
                            final result = await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => ProductEditPage(product: pro , nameShop: widget.nameShop)));
                            if(result){
                              setState(() {
                                Product.products.clear();
  _loadData(widget.nameShop);
